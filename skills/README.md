...
| scan | [scan.md](scan.md) | 15 | 正则+AST-lite，非编译器语义；覆盖矩阵见 VULN-HUNTING 附录 B；含知识库与可选引擎 |
| ide | [ide.md](ide.md) | 22 | LSP 仅 2 语言（缺失如实报 + impact 文本降级，S99）；build/debug/break 走真实工具链；S125 调用图（nameres 同引擎） |
